...
function onMsgNotify(newMsgList) {
    ...
    for (var j in newMsgList) { // 遍历新消息
        newMsg = newMsgList[j];
        // webim.Log.warn('receive a new c2c msg');
            ...
            setProfilePortrait({
                'ProfileItem': [
                    ...
                    },
                    {
                        ...
                        "Value": profile.icon
                        // "Value": 'http://img2.imgtn.bdimg.com/it/u=2427473906,1629620274&fm=26&gp=0.jpg'
                    }
                ]
            }, function () {
...
function init(opts) {
    ...
    selSessHeadUrl = opts.selSessHeadUrl;
...
module.exports = {
    ...
    convertSoundMsgToHtml,
    convertFileMsgToHtml,
    convertLocationMsgToHtml,
    convertCustomMsgToHtml,
    convertGroupTipMsgToHtml,
    tlsLogin,
    tlsGetUserSig,
    imageClick,
    onChangePlayAudio,
    ...
    quitBigGroup,
    logout,
    onApplyJoinGroupRequestNotify,
    onApplyJoinGroupAcceptNotify,
    onApplyJoinGroupRefuseNotify,
    onKickedGroupNotify,
    onDestoryGroupNotify,
    onCreateGroupNotify,
    onInvitedJoinGroupNotify,
    onQuitGroupNotify,
    onSetedGroupAdminNotify,
    onCanceledGroupAdminNotify,
    onRevokeGroupNotify,
    onCustomGroupNotify,
